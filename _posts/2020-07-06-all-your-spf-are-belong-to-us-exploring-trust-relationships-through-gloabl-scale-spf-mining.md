...
**(Update 7/7/2020)** I received this message from [Ken Simpson](https://www.linkedin.com/in/ksimpson/), CEO of MailChannels, that helps explain why there is a mismatch between the MX and SPF counts.
